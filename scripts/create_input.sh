...
sed -i "s/${n20_ip_in_file}/${juju_n20_ip}/g" contrail_test_input.yaml
sed -i "s/${n19_ip_in_file}/${juju_n19_ip}/g" contrail_test_input.yaml
sed -i "s/${kstone_ip_in_file}/${juju_kstone_ip}/g" contrail_test_input.yaml
